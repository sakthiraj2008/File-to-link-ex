...
class Var(object):
    ...
    API_HASH = str(getenv('API_HASH', 'c78c50d54baf2173e8b3f75c359c0c72'))
    BOT_TOKEN = str(getenv('BOT_TOKEN', '7754306060:AAGBIJsYxqYe9vUPKuCsg5t7i5xS786ufWk'))
    name = str(getenv('name', 'Fast_Downloader_bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002262171720'))
    ...
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', 'CODER_KAKASHI_BOTr'))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'TN_botz'))
